...
public class Argelia extends Pais{
    ...
    public String implimir(){
        String  todo=" <font color=\"white\">"+"Pais: "+getPais()+" Argelia"+"<br>"+"Capital: "+getCapital()+"<br>Idioma: "+getIdioma()+"<br>Moneda: "+getMoneda()+"<br>Gentilicio: "+getGentilicio()+"<br>"+palabra+"="+getTexto()+"<br>"+cantidad+" Pesos "+"="+getCalcular()+" Dinares";
        return todo;
    }
